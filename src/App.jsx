...
export default function App() {
  ...
  return (
    <div class="container">
      ...
      <section class="cards">
        <a class="card" href="https://github.com/stephenglass" target="_blank">
          ...
          <div class="card-content">
            ...
            <div class="card-desc">View my projects and code.</div>
          </div>
        </a>
        <a
          class="card"
        ...
        >
          ...
          <div class="card-content">
            ...
            <div class="card-desc">Connect with me professionally.</div>
          </div>
        </a>
        <a class="card" href="mailto:stephen@example.com">
          <div class="card-header">
            <span class="icon">
              {/* Email SVG */}
              <svg
          ...
          <div class="card-content">
            ...
            <div class="card-desc">Send me an email.</div>
          </div>
        </a>
      </section>
    </div>
